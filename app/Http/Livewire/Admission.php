...
class Admission extends Component
{
    ...
    public function searchResult(){
        return $this->leads = Lead::where('name', 'like',  "%{$this->search}%" )->orWhere('email', 'like',"%{$this->search}%")->orWhere('phone', 'like', "%{$this->search}%")->get();
    }
